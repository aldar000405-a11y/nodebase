        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg bg-muted p-4 space-y-2">
            ...
            >
              ...
              <li>
                Open the script editor from the Form (Extensions → Apps Script)
              </li>
              <li>Copy and paste the script below</li>
              <li>Replace WEBHOOK_URL with your webhook URL above</li>
              <li>Save and click "Trigger" then Add Trigger</li>
              <li>
                If your script is form-bound, choose "From form" then "On form
                submit" then Save
              </li>
              <li>
                If you created a standalone script, link the Form to a response
                Sheet and create the trigger "From spreadsheet" then "On form
                submit"
              </li>
            </ol>
          </div>
