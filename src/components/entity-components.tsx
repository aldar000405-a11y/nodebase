...
import { AlertTriangleIcon, Loader2Icon, MoreVerticalIcon,
     PackageOpenIcon, PlusIcon, SearchIcon, TrashIcon } from "lucide-react";
...
export const EntitySearch = ({
    ...
    return (
        <div className="relative ml:auto">
            ...
            <Input className="max-w-[200px] bg-background shadow-none
             border-border pl-8"
